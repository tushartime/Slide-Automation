"use client"
import { createAutomations, deleteKeyword, saveKeyword, saveListener, savePosts, saveTrigger, updateAutomation, updateAutomationName } from "@/actions/automations"
...
export const useListeners = (id: string)=>{
  ...
  const {errors, register, reset, watch, onFormSubmit} = useZodForm(promptSchema, mutate);
...
export const useAutomationPost = (id: string) => {
  ...
  const onSelectPost = (post: {
    ...
    return {onSelectPost, posts, isPending, mutate}
}